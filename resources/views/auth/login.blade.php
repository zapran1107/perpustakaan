...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('auth/assets/images/smk assalaam.png') }}" />
</head>
<body src="{{asset('auth/assets/images/pp.png')}}" alt="">
{{-- <body style=" background-image: url('auth/assets/images/pp.png');
                    ...
                    <div class="card col-lg-4 mx-auto">
                        ...
                        <div class="card-body px-5 py-5">
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <img src="{{ asset('auth/assets/images/smk assalaam.png') }}" alt=""
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row mb-3">
                                    <label for="email"
                                        class="col-md-12 col-form-label">{{ __('Masukan Email') }}</label>
                                ...
                                <div class="col-12">
                                    <div class="text-start">
                                        <p class="mb-0">belum punya akun? <a href="{{ route('register') }}">Register di sini</a>
                                        </p>
                                    </div>
                                </div>
                            </form>
